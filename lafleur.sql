...
(3, 'le Cœur de Marie', 29.99, 5786, 'Le Cœur de Marie est une plante vivace, qui a des fleurs roses et blanches en forme de cœur. Elle peut atteindre 120 cm de haut et 45 cm de large.', 'coeurDeMarie.png', 3),
...
(16, 'Anémone', 12.99, 79, 'L’anémone de terre est une plante à fleur qui appartient à la famille des Renonculacées. Elle se présente sous forme de bulbe ou de rhizome et produit des fleurs simples ou doubles, souvent rouges, bleues ou blanches.', 'anémone.png', 3),
